            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a href="{{ url('admin/assign_class/add') }}" class="btn btn-primary">Add New Assign Class</a>
                    </div>
                </div>
            </div>
        </section>
                                    ...
                                    <tbody>
                                        @foreach ($getRecord as $value)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/assign_class/edit/' . $value->id) }}"
                                                        class="btn btn-primary">Edit</a>
                                                    <a href="{{ url('admin/assign_class/edit_single/' . $value->id) }}"
                                                        class="btn btn-primary">Edit Single</a>
                                                    <a href="{{ url('admin/assign_class/delete/' . $value->id) }}"
